...
_Static_assert(sizeof(RiscvReriControl) == sizeof(uint64_t));
...
_Static_assert(sizeof(RiscvReriStatus) == sizeof(uint64_t));
...
_Static_assert(sizeof(RiscvReriBankInfo) == sizeof(uint64_t));
...
_Static_assert(sizeof(RiscvReriVendorImpId) == sizeof(uint64_t));
